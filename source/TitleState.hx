...
gfDanceTitle = new FlxSprite(250, 512);
		gfDanceTitle.frames = Paths.getSparrowAtlas('
gfDanceTitle');
		gfDanceTitle.animation.addByPrefix('idle', "gfDanceTitle", 24);
        gfDanceTitle.animation.addByPrefix('down', "gfDance", 24);
        gfDanceTitle.animation.addByPrefix('up', "gfDance", 24);
        gfDanceTitle.animation.addByPrefix('Left', "gfDance", 24);
        gfDanceTitle.animation.play('idle');
        gfDanceTitle.scale.set(1,1);
		gfDanceTitle.antialiasing = ClientPrefs.globalAntialiasing;
		add(gfDanceTitle);
        
        initX = gfDanceTitle.x;
        initY = gfDanceTitle.y;
